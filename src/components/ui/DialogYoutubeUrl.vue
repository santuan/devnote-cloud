      ...
      >
        ...
        <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
          <input
            ...
            class="flex h-10 w-full rounded-md text-foreground border border-secondary bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
