      ...
      >
        ...
        <DropdownMenuGroup class="flex justify-between w-full p-3 bg-secondary">
          <DropdownMenuItem
            ...
            class="rounded-full outline-none size-4 bg-rose-500 hover:ring-2 focus-visible:ring-2 ring-rose-500/50 ring-offset-1"
          ...
          <DropdownMenuItem
            ...
            class="bg-blue-500 rounded-full outline-none size-4 hover:ring-2 focus-visible:ring-2 ring-blue-500/50 ring-offset-1"
          ...
          <DropdownMenuItem
            ...
            class="bg-green-500 rounded-full outline-none size-4 hover:ring-2 focus-visible:ring-2 ring-green-500/50 ring-offset-1"
          ...
          <DropdownMenuItem
            ...
            class="bg-yellow-500 rounded-full outline-none size-4 hover:ring-2 focus-visible:ring-2 ring-yellow-500/50 ring-offset-1"
